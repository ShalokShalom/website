...
<h2>Windows</h2>
[s-var slug="exeurl"][s-var slug="exe"][s-var slug="endlink"] has been tested on a number of 32 and 64 bit versions of Windows, including XP, Windows 7, Windows 8 and Windows 10.
<h2>Mac</h2>
[s-var slug="dmgurl"][s-var slug="dmg"][s-var slug="endlink"] is a Mac image that can be installed on 64bit Intel Macs running MacOS 10.7 or later by dragging the Subsurface.app to your <tt>/Applications</tt> folder.
<h2>Linux</h2>
...
<h2>Ubuntu (14.04, 15.04, 15.10, and 16.04), LinuxMint (17), and Debian Jessie</h2>
...
<h2>OpenSUSE 13.1 / 13.2 / Tumbleweed and Fedora 22, 23</h2>
To install the official Subsurface package under OpenSUSE 13.1, 13.2, or Tumbleweed as well as Fedora 22, 23, go to <a href="http://software.opensuse.org/download.html?project=home:Subsurface-Divelog&amp;package=subsurface">our build service project page</a> and follow the simple instructions there - it's as easy as two clicks.
...
<h2>Deprecated distribution maintained packages</h2>
...
<h2>Sources</h2>
Sources are of course available via <a href="http://git.subsurface-divelog.org/index.cgi?p=subsurface.git;a=summary">git</a> or as a release tar-ball [s-var slug="srctarurl"][s-var slug="srctar"][s-var slug="endlink"]. The sources of the GPL and LGPL components shipped with the Mac and Windows binaries can be found at <a href="http://www.macports.org/">MacPorts</a> and <a href="http://sourceforge.net/projects/mingw/files/">MinGW</a>.
